import { USER_LOGIN_FAIL,USER_LOGIN_SUCCESS,USER_LOGOUT,USER_LOGIN_REQUEST,
    ...
    USER_REGISTER_FAIL,USER_REGISTER_SUCCESS,USER_REGISTER_REQUEST,USER_DETAILS_REQUEST,
...
export const userLoginReducers =(state={},action)=>{
    ...
    switch(action.type){
        ...
        case USER_LOGIN_SUCCESS:
            return {loading:false,userInfo:{...action.payload,token: action.payload.token}}
